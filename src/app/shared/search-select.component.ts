...
@Component({
  ...
  styles: [`
    ...
    .trigger { display: inline-flex; align-items: center; gap: 4px; border: 1px dashed var(--dtt-line);
      background: var(--dtt-card); border-radius: 8px; padding: 6px 12px; cursor: pointer; color: var(--dtt-muted); font-size: 13px; }
    ...
    .pop { position: fixed; z-index: 200; width: 320px; max-width: 90vw;
      background: var(--dtt-card); border: 1px solid var(--dtt-line); border-radius: 10px; box-shadow: 0 12px 28px rgba(0,0,0,.18); overflow: hidden; }
    ...
    .opt:hover, .opt:first-child { background: var(--dtt-tint); }
